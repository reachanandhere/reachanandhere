...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,react,angular,python,nodejs,express,electron,bootstrap,firebase,docker,kubernetes,aws,tailwind)](https://skillicons.dev)
